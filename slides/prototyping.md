...
![bg left Rough paper wireframes on a wooden desk](../assets/images/prototyping.jpeg)
...
<style scoped>h1{font-size: 48px;}</style>

# Prototyping enables exploration

![bg right Designer Tom Wujec](../assets/images/wujec.jpg)
...
![bg Light bulb moves through prototype machine and is transformed into a market ready idea. Text on the image says test early, test often](../assets/images/early-and-often.png)
...
![bg right:40% w:400 Image of the Zappos.com logo and a mini austin car](../assets/images/mvp.png)
...
![bg w:1000 A circle with text label 'low fidelity' and an arrow pointing towards a circle with the text label 'high fidelity'](../assets/images/low-to-high.png)
...
![w:700 The sketch to prototype continuum from Bill Buxton's Sketching User Experiences](../assets/images/prototyping-purpose.png)
...
![bg w:800 Tracy Lepore's Sketch to Design Continuum](../assets/images/prototype-spectrum.png)
...
![bg w:1100 Logos for high fidelity prototyping tools including Figma, Adobe XD, Protopie and Marvel](../assets/images/prototyping-tools.png)
...
![bg right:40%](../assets/images/figma.png)
...
<div style="display: block;margin-left: auto;margin-right: auto; width:30%; height:700px;" ><a href="https://www.figma.com/design/jyE41FS0o4wSr6Uf5mFrzI/Muutro?node-id=0%3A1&t=WSoKf3UPvMC6EXZq-1
" target="_blank"><img src="../assets/images/muutro-hi.png" height="600" alt="Muutro High Fidelity Landing Page"></a></div>
...
![bg left:40%](../assets/images/figma.png)
